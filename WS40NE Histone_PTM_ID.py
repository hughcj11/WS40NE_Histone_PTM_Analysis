...
import csv
import re
base_path = "/Users/chelseahughes/Desktop/Histone Analysis/code/WS40NE Library/"
#Below creates a dictionary within the code of unimod IDs and their biological relevance for later use.
with open("/Users/chelseahughes/Desktop/Histone Analysis/code/Testing code WS40NE/UnimodLibrary.csv") as csvfile:
...
#The below document is a list of the unique histone names identified. It is not a list of unique histone IDs 
